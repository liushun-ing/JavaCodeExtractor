...
public abstract class AbstractSearchProvider {
     ...
     * 		parent window
     */
    public abstract void openSearchDialog(org.eclipse.ui.IWorkbenchWindow window);
     ...
     */
    public abstract void runSearchQuery(org.eclipse.mylyn.internal.tasks.core.ITaskList tasklist, org.eclipse.mylyn.tasks.core.TaskRepository repository, org.eclipse.mylyn.tasks.core.IRepositoryQuery query, boolean activateResultView);
}