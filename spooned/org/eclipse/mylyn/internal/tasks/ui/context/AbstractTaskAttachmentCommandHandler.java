 ...
 */
public abstract class AbstractTaskAttachmentCommandHandler extends org.eclipse.core.commands.AbstractHandler {
        ...
        if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
            ...
            for (java.lang.Object item : items) {
                if (item instanceof org.eclipse.mylyn.tasks.core.ITaskAttachment) {
                    execute(event, ((org.eclipse.mylyn.tasks.core.ITaskAttachment) (item)));
                }
            }
        }
        return null;
