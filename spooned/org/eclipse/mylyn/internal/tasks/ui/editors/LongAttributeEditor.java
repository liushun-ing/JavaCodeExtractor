 ...
 */
public class LongAttributeEditor extends org.eclipse.mylyn.internal.tasks.ui.editors.TextAttributeEditor {
    public LongAttributeEditor(org.eclipse.mylyn.tasks.core.data.TaskDataModel manager, org.eclipse.mylyn.tasks.core.data.TaskAttribute taskAttribute) {
        ...
        return new org.eclipse.jface.dialogs.IInputValidator() {
            public java.lang.String isValid(java.lang.String newText) {
                if (org.apache.commons.lang.StringUtils.isNotBlank(newText)) {
                    try {
                        java.lang.Long.parseLong(newText);
